...
import { login, clearError, loginWithGoogle } from '../../store/slices/authSlice';
...
export function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    // En una implementación real, aquí se integraría con la API de Google
    ...
    try {
      ...
      // await dispatch(loginWithGoogle(googleTokenId)).unwrap();
      // navigate('/dashboard');
    } catch (error) {
      toast({
        variant: 'destructive',
